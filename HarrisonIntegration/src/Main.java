...
/*
 * The rest of my code is in the other files Calculator.java has all arithmetic
 * operators and casting requirement Classes.java has a class, object, getter
 * and setter Methods.java has a method declared and invoked Strings.java
 * manipulates text with 4 String class methods
 */
